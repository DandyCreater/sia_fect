...
class ELearningStudentPage extends StatefulWidget {
  static const String routeName = '/schedule-student';

  const ELearningStudentPage({Key? key}) : super(key: key);

  @override
  State<ELearningStudentPage> createState() => _ELearningStudentPageState();
}

class _ELearningStudentPageState extends State<ELearningStudentPage> {
  List myShedule = [];
